...
SECRET_KEY = 'django-insecure-@$9ps%-07ucvvq4^*smlj0!rkw0p5h=m5f%_l6djippj!lr@23'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [],  # Убедитесь, что здесь ничего нет, если вы не используете аутентификацию
